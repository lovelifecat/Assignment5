...
class TestTriangle(unittest.TestCase):
    ...
    def test_classify_ScaleneButNotRight(self):
        self.assertEqual(triangle.classify(4, 3, 6), 'scalene')
        self.assertEqual(triangle.ifright(4, 3, 6), 'Not Right')

    def test_classify_isosceles(self):
        self.assertEqual(triangle.classify(3, 4, 3), 'isosceles')
        self.assertEqual(triangle.ifright(3, 4, 3), 'Not Right')
    ...
    def test_classify_Equilateral(self):
        ...
        # Equilateral Triangles are impossible to cobe right triangles #
